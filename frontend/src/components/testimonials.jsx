        ...
        <section class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
            <div class="p-8 border rounded-lg dark:border-gray-700">
                <p class="leading-loose text-gray-500 dark:text-gray-400">
                    “Donating food through this platform has been an incredibly fulfilling experience. Knowing my contributions are helping those in need brings me joy.”
                </p>
                ...
                <div class="flex items-center mt-8 -mx-2">
                    ...
                    <div class="mx-2">
                        <h1 class="font-semibold text-gray-800 dark:text-white">Anna Smith</h1>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Community Volunteer</span>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 bg-blue-500 border border-transparent rounded-lg dark:bg-blue-600">
                <p class="leading-loose text-white">
                    “I love being a part of this initiative! It's amazing to see how our efforts collectively make a huge difference in our community.”
                </p>
                ...
                <div class="flex items-center mt-8 -mx-2">
                    ...
                    <div class="mx-2">
                        <h1 class="font-semibold text-white">Michael Johnson</h1>
                        <span class="text-sm text-blue-200">Food Donor</span>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 border rounded-lg dark:border-gray-700">
                <p class="leading-loose text-gray-500 dark:text-gray-400">
                    “The process was easy, and I felt supported every step of the way. I’ll definitely continue to donate through this platform.”
                </p>
                ...
                <div class="flex items-center mt-8 -mx-2">
                    ...
                    <div class="mx-2">
                        <h1 class="font-semibold text-gray-800 dark:text-white">Sarah Lee</h1>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Local Business Owner</span>
                    </div>
                </div>
            </div>
        </section>
